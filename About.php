  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-c246"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="index.php" style="padding: 10px 20px;">Login</a>
</li></ul>
          </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="index.php">Login</a>
</li></ul>
              </div>
            </div>
    ...
    <div class="wrapper wrapper--w960">
        <div class="card card-2">
          <div class="card-body">
                <h2 class="title" align="center">Formulir Pendaftaran Wisata</h2>
                <form method="POST">
