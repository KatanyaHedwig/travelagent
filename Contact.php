      ...
      <div class="container">
        <div class="wrapper wrapper--w960">
          <div class="card card-2">
            ...
            <h2 class="title" align="center">Contact Us</h2>
            <form method="POST">
                <div class="input-group" >
                  <div class="shadow-lg p-3 mb-5 bg-white rounded">
                    <a href="instagram.com/katanyarandita/">
                      <h5 class="title" align="center">Instagram</h5>
                    </a>
                  </div>

                  <div class="shadow-lg p-3 mb-5 bg-white rounded">
                    <a href="https://wa.me/62895395089295/">
                      <h5 class="title" align="center">WhatApps</h5>
                    </a>
                  </div>
                  <div class="shadow-lg p-3 mb-5 bg-white rounded">
                    <a href="mailto:hedwigrandita22@gmail.com">
                      <h5 class="title" align="center">Email Administrator</h5>
                    </a>
                  </div>
                </div>

                <p align="center">
                  Silahkan menghubungi kontak diatas jika ada pertanyaan mengenai jadwal ataupun pemesanan.
                </p>
